...
public class PrimaryKeyFactory {
     ...
     */
    private Map<Class<? extends RealmModel>, AtomicLong> keys; // Changed from RealmObject
    ...
    public synchronized void initialize(final Realm realm) {
        ...
        for (final Class<? extends RealmModel> c : configuration.getRealmObjectClasses()) { // Changed from RealmObject
     ...
     */
    public synchronized long nextKey(final Class<? extends RealmModel> clazz) { // Changed from RealmObject
        if (keys == null) {
